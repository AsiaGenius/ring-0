...
carrega.NumberOfPrt = 1;		//Number  of protected files Default: 3 (only 3 file protected in this case)

carrega.ProtectA = "0x5339965e:data.grf";
carrega.ProtectB =  "0x5339965e:my_ro.exe";
carrega.ProtectC = "0x5339965e:my_ro.grf";
carrega.ProtectD = "0x5339965e:DATA.INI";
carrega.ProtectE = "0x5339965e:files.grf";
carrega.ProtectF = "0x5339965e:palleta.grf";
carrega.ProtectG = "0x5339965e:jobs.grf";
carrega.ProtectH = "0x5339965e:cps.dll";
carrega.ProtectI = "0x5339965e:GameGuard/ring.dll";		//    <<<---  IMPORTANT!!!!! IMPORTANT!!!!!!!!! ATTENTION!!!  GameGuard/ring.dll
carrega.ProtectJ = "0x5339965e:BGM/1.mp3";
